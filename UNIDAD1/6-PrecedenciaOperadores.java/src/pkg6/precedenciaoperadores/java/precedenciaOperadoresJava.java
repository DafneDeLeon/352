package pkg6.precedenciaoperadores.java;
    ...
    public static void calculoOperaciones(double a, double b ,double c, double d, double e, double f, 
      ...
      DecimalFormat df = new DecimalFormat("#.00");
       ...
       Scanner scanner =new Scanner(System.in);
        ...
        System.out.println("a: " + df.format(calculoA));
        double calculoB = (1 / (x - 5)) - ((3 * x * y) / 4);
        System.out.println("b: " + df.format(calculoB));
        double calculoC = (1 / 2) + 7;
        System.out.println("c: " + df.format(calculoC));
        double calculoD = 7 + (1 / 2);
        System.out.println("d: " + df.format(calculoD));
        double calculoE = ((a * a) / (b - c)) + ((d - e) / (f - ((g * h) / j)));
        System.out.println("e: " + df.format(calculoE));
        double calculoF = (m / n) + p;
        System.out.println("f: " + df.format(calculoF));
        double calculoG = m + (n / (p - q));
        System.out.println("g: " + df.format(calculoG));
        double calculoH = ((a * a) / (b * b)) + ((c * c) / (d * d));
        System.out.println("h: " + df.format(calculoH));
        double calculoI = (m / (n / p) ) / (q - (r / s));
        System.out.println("i: " + df.format(calculoI));
        double calculoJ = ((3 * a) + b) / (c - ((d + 5 * e) / (f + (g / (2 * h)))));
        System.out.println("j: " + df.format(calculoJ));
        double calculoK = (a * a + 2 * a * b + b * b) / ((1 / (x * x)) + 2);
        System.out.println("k: " + df.format(calculoK));
    }
}
